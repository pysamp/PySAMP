from pysamp import (
    textdraw_alignment,
    textdraw_background_color,
    textdraw_box_color,
    textdraw_color,
    textdraw_create,
    textdraw_destroy,
    textdraw_font,
    textdraw_hide_for_all,
    textdraw_hide_for_player,
    textdraw_show_for_player,
    textdraw_letter_size,
    textdraw_set_outline,
    textdraw_set_preview_model,
    textdraw_set_preview_rot,
    textdraw_set_preview_veh_col,
    textdraw_set_proportional,
    textdraw_set_selectable,
    textdraw_set_shadow,
    textdraw_set_string,
    textdraw_show_for_all,
    textdraw_text_size,
    textdraw_use_box,
)
...
class TextDraw:
    ...
    def create(cls, x: float, y: float, text: str) -> "TextDraw":
        ...
        """
        return cls(textdraw_create(x, y, text))
    ...
    def destroy(self) -> bool:
        ...
        """
        return textdraw_destroy(self.id)
    ...
    def letter_size(self, x: float, y: float) -> bool:
        ...
        """
        return textdraw_letter_size(self.id, x, y)
    ...
    def text_size(self, x: float, y: float) -> bool:
        ...
        """
        return textdraw_text_size(self.id, x, y)
    ...
    def alignment(self, alignment: int) -> bool:
        ...
        .. note::
            ...
            need to be swapped.
        """
        return textdraw_alignment(self.id, alignment)
    ...
    def color(self, color: int) -> bool:
        ...
        .. note:: The textdraw must be re-shown to the player in order to
            update the color.
        """
        return textdraw_color(self.id, color)
    ...
    def use_box(self, box: bool) -> bool:
        ...
        :return: This method does not return anything.
        """
        return textdraw_use_box(self.id, box)
    ...
    def box_color(self, color: int) -> bool:
        ...
        :return: This method does not return anything.
        """
        return textdraw_box_color(self.id, color)
    ...
    def set_shadow(self, shadow_size: int) -> bool:
        ...
        .. note::
            ...
            for the area.
        """
        return textdraw_set_shadow(self.id, shadow_size)
    ...
    def set_outline(self, outline_size: int) -> bool:
        ...
        :return: This method does not return anything.
        """
        return textdraw_set_outline(self.id, outline_size)
    ...
    def background_color(self, color: int) -> bool:
        ...
        .. note::
            ...
            - Changing the value of color seems to alter the color used in\
              :meth:`color`
        """
        return textdraw_background_color(self.id, color)
    ...
    def font(self, font: int) -> bool:
        ...
        """
        return textdraw_font(self.id, font)
    ...
    def set_proportional(self, proportional: bool) -> bool:
        ...
        :return: Does not return anything.
        """
        return textdraw_set_proportional(self.id, proportional)
    ...
    def set_selectable(self, selectable: bool) -> bool:
        ...
        """
        return textdraw_set_selectable(self.id, selectable)
    ...
    def show_for_all(self) -> bool:
        ...
        :return: This method does not return anything.
        """
        return textdraw_show_for_all(self.id)
    ...
    def hide_for_all(self) -> bool:
        ...
        :return: This method does not return anything.
        """
        return textdraw_hide_for_all(self.id)
    ...
    def set_string(self, string: str) -> bool:
        ...
        """
        return textdraw_set_string(self.id, string)
    ...
    def set_preview_model(self, model_index: int) -> bool:
        ...
        :return: This method does not return anything.
        """
        return textdraw_set_preview_model(self.id, model_index)

    def set_preview_rotation(self, rotation_x: float, rotation_y: float, rotation_z: float, zoom: float = 1.0) -> bool:
        """
        ...
        :return: This method does not return anything.
        """
        return textdraw_set_preview_rot(self.id, rotation_x, rotation_y, rotation_z, zoom)
    ...
    def set_preview_vehicle_color(self, color1: int, color2: int) -> bool:
        ...
        """
        return textdraw_set_preview_veh_col(self.id, color1, color2)
    ...
    def hide_for_player(self, player: "Player") -> bool:
        ...
        :return: This method does not return anything.
        """
        return textdraw_hide_for_player(player.id, self.id)
    ...
    def show_for_player(self, player: "Player") -> bool:
        ...
        :return: This method does not return anything.
        """
        return textdraw_show_for_player(player.id, self.id)
