...
class TextDraw:
    ...
    def use_box(self, enable: bool) -> bool:
        """Toggle the box on the textdraw.

        :param bool enable: ``True`` to use a box, ``False`` to hide the box.
        :return: This method does not return anything.
        """
        return textdraw_use_box(self.id, enable)
    ...
    def set_proportional(self, enable: bool) -> bool:
        ...
        :return: Does not return anything.
        """
        return textdraw_set_proportional(self.id, enable)
    ...
    def set_selectable(self, enable: bool) -> bool:
        ...
        """
        return textdraw_set_selectable(self.id, enable)
    ...
    def set_preview_model(self, model_id: int) -> bool:
        ...
        :return: This method does not return anything.
        """
        return textdraw_set_preview_model(self.id, model_id)
    ...
    def set_preview_rotation(
        ...
        :return: This method does not return anything.
        """
        return textdraw_set_preview_rot(
