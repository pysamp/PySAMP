...
class TextLabel:
    ...
    def attach_to_player(self, player: "Player", offset_x: float, offset_y: float, offset_z: float) -> bool:
        """
        ...
        """
        return attach_3d_text_label_to_player(self.id, player.id, offset_x, offset_y, offset_z)

    def attach_to_vehicle(self, vehicle: "Vehicle", offset_x: float, offset_y: float, offset_z: float) -> bool:
        """
        ...
        :return: This method does not return anything.
        """
        return attach_3d_text_label_to_vehicle(self.id, vehicle.id, offset_x, offset_y, offset_z)
