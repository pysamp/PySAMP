...
class Vehicle:
    ...
    def set_params_for_player(self, player: "Player", objective: int, doors_locked: int) -> bool:
        """ Set the parameters on the vehicle. """
        return set_vehicle_params_for_player(self.id, player.id, objective, doors_locked)
    ...
    def set_params_ex(self, param: Tuple[int, int, int, int, int, int, int]) -> bool:
        ...
        try:
            ...
            return set_vehicle_params_ex(self.id, engine, lights, alarm, doors, bonnet, boot, objective)
    ...
    def set_params_car_doors(self, doors: Tuple[int, int, int, int]) -> bool:
        ...
        try:
            ...
            return set_vehicle_params_car_doors(self.id, driver, passenger, backleft, backright)
    ...
    def set_params_car_windows(self, windows: Tuple[int, int, int, int]) -> bool:
        ...
        try:
            ...
            return set_vehicle_params_car_windows(self.id, driver, passenger, backleft, backright)
    ...
    def add_component(self, component_id: int) -> bool:
        ...
        https://open.mp/docs/scripting/resources/carcomponent_id
    ...
    def on_unoccupied_update(
        ...
        return (cls(vehicle_id), Player(player_id), passenger_seat, new_x, new_y, new_z, vel_x, vel_y, vel_z)
